...
const Footer = () => {
  ...
  return (
    <>
      {location.pathname === '/' ? (<footer className="bg-black text-white">
      ...
      </footer>) : (<footer className="bg-black text-white"><div className='py-8 pr-8 flex flex-row justify-center'>
        <p>© {new Date().getFullYear()} SHOOPER. All rights reserved.</p>
      </div></footer>)}
    </>
  );
